...
| `check-pack.mjs` | `npm run pack:dry-run` | yes | Runs `npm pack --dry-run --json` and asserts required runtime files are included while source/internal directories are excluded. |
