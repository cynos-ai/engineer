...
Public documentation for Cynos Engineer:

- [Architecture](./architecture.md) — public runtime model and extension boundaries.
...
Historical design notes, private benchmark material, maintainer-only skills, and
internal smoke-test assets are kept outside the public source repository.
